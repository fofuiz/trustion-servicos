...
public class ConciliacaoCartaoDetalheCartaoMapper2 implements RowMapper<DetalheConciliacaoCartaoEntity> {
    ...
    public DetalheConciliacaoCartaoEntity mapRow(ResultSet rs, int rowNum) throws SQLException {
        ...
        entity.setNomeOperadora(rs.getString("NME_OPERADORA"));
        ...
        try {
            entity.setDataExtrPagamento(rs.getDate("COD_DATA_CREDITO"));
        } catch (SQLException ex) {
